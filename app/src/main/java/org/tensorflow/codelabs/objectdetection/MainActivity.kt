...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private val mUrlDisplayTextView: TextView? = null
    private val mSearchResultsTextView: TextView? = null

    private val mLoadingIndicator: ProgressBar? = null

    private val mErrorMessageDisplay: TextView? = null

    private val loginButton: Button? = null
    private val esqueciButton: Button? = null
    private val semsenhaButton: Button? = null
    ...
    private fun makeLoginQuery() {
        val username: String = usernameEditText.toString()
        val password: String = passwordEditText.toString()
        var loginSite: URL? = null
        ...
        if (username.isEmpty() || password.isEmpty()) Toast.makeText(
            ...
            loginSite = NetworkUtils.applogin(username, password)
            //br.edu.utfpr.geladeira_v7.LoginActivity.AppLogin().execute(loginSite)
        }
    }
